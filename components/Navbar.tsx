          ...
          >
            <div className='overflow-hidden rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 bg-aex-300'>
              ...
              <div className='px-2 pt-2 pb-3'>
                {navigation.map((item) => (
                  <Link key={item.name} href={item.href}>
                    <a className='block px-3 py-2 text-base font-medium text-gray-100 rounded-md hover:text-gray-300 hover:bg-aex-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-aex-accent'>
                      {item.name}
                    </a>
                  </Link>
                ))}
